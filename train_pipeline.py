...
BASE_FEATURES = [
    "kepid", "koi_period", "koi_period_err1", "koi_period_err2",
    "koi_time0bk", "koi_time0bk_err1", "koi_time0bk_err2", "koi_impact",
    "koi_impact_err1", "koi_impact_err2", "koi_duration", "koi_depth",
    "koi_prad", "koi_prad_err1", "koi_prad_err2", "koi_teq",
    "koi_model_snr", "koi_steff", "koi_steff_err1", "koi_steff_err2",
    "koi_slogg", "koi_slogg_err1", "koi_slogg_err2", "koi_srad",
    "koi_srad_err1", "koi_srad_err2", "ra_x", "dec_x", "koi_kepmag",
    "fpp_prob", "ra_y", "dec_y", "kepmag", "teff", "teff_err1", "teff_err2",
    "logg", "logg_err1", "logg_err2", "feh", "feh_err1", "feh_err2",
    "radius", "radius_err1", "radius_err2", "mass", "mass_err1",
    "mass_err2", "dens", "dens_err1", "dens_err2", "nconfp", "nkoi", "ntce",
    "st_quarters", "tce_period", "tce_duration", "tce_depth",
    "tce_model_snr"
]
